...
- Name: Editor page >> html editor allows editing
- Location: C:\Users\louis\Documents\srcbox\frontend\tests\main.spec.ts:225:9
...
Locator: getByText('<div id="test">Hello</div>', { exact: true })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('<div id="test">Hello</div>', { exact: true })

    at C:\Users\louis\Documents\srcbox\frontend\tests\main.spec.ts:233:61
```
